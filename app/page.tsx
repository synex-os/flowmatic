...
export default function Home() {
  ...
  const prosModules = [
    { id: 'p1', title: 'הארכיטקטורה מאחורי הקלעים', duration: '60 דק׳', points: [
      'איך הפלטפורמה באמת בנויה מתחת למכסה — לדעת למה דברים עובדים, למה הם נשברים, ואיך לתקן לבד',
      'OpenClaw לעומת LangChain ו-CrewAI — מה מתאים מתי, ולמה הבחירה הזו חשובה לעסק שלכם',
      'Cloud-init — איך השרת מקים את עצמו אוטומטית, בלי שתיגעו בטרמינל',
      'בחירת VPS לפי עומס אמיתי — בלי לשלם על מה שלא צריכים',
      'Docker, nginx, Caddy ו-SSL אוטומטי — למה זה חשוב גם אם לא תיגעו בהם לבד',
      'מתי 4GB מספיקים, מתי לשדרג — החלטה מבוססת נתונים, לא ניחוש'
    ]},
    { id: 'p2', title: 'אסטרטגיית מודלים — חיסכון של עד 90% בעלויות', duration: '60 דק׳', points: [
      'מתי להשתמש במודל זול ומתי משתלם לשלם יותר — המתודולוגיה שמאחורי החיסכון',
      'Claude Haiku, Sonnet ו-Opus — איך כל אחד מתנהג בפועל, ומתי לבחור את מי',
      'איך לשלם $2 במקום $200 על אותה איכות פלט — בלי פשרות',
      'LiteLLM Gateway — שער חכם שמחליט בעצמו איזה מודל להפעיל לאיזו משימה',
      'Ollama (מודל שרץ מקומית על השרת שלכם) — מתי זה משתלם, מתי לא',
      'ניתוב חכם בין ספקים — לא להיות שבויים של אף אחד'
    ]},
    { id: 'p3', title: 'זיכרון הסוכן — איך הוא לומד את העסק שלכם', duration: '90 דק׳', points: [
      'איך הסוכן באמת "זוכר" את העסק שלכם — לא קסם, מבנה ברור שתלמדו לשלוט בו',
      'USER.md — הבית של כל הידע על העסק. מה לשים שם, באיזה סדר, ולמה זה משנה',
      'BRAND.md — להבטיח שהקול והטון של המותג נשמעים עקביים בכל פלט, בכל ערוץ',
      'Entity Consensus — העיקרון שבזכותו גוגל מזהה שמדובר באותו מותג בכל מקום',
      'כתיבת Skills מותאמים (Python / Node) — לבנות יכולות חדשות לסוכן בעצמכם',
      'ClawHub Marketplace — מאגר Skills מוכנים לשימוש, ואיך לבחור מה באמת שווה',
      'תרגיל חי — עריכת USER.md מתוך הפלטפורמה וראיית ההשפעה מיידית'
    ]},
    { id: 'p4', title: '9 סוכני MATEH — להגדיר כל אחד בדיוק לעסק שלכם', duration: '120 דק׳', points: [
      'לצאת מברירת המחדל — להגדיר כל סוכן מחדש, בדיוק למה שאתם צריכים',
      'Sayer — סוכן ריגול תחרותי. להגדיר prompts, מודלים ותזמון מדויקים',
      'Meater — סריקת SERP יומית דרך DataForSEO. לראות כל תזוזה בגוגל בזמן אמת',
      'Maazin — האזנה חברתית בפייסבוק וברדיט. לדעת מה אומרים עליכם',
      'Menateach — לסנתז מידע מכל המקורות לסיכום יומי שבאמת מועיל',
      'Ayat / Et — לכתוב תוכן עם Entity Consensus שמחזיק את זהות המותג',
      'Yotzer — pipeline שלם ליצירת ויזואלים אוטומטית',
      'Shaliach — פרסום רב-ערוצי עם מעקב CTR בכל ערוץ בנפרד',
      'Migdalor — איך לגרום למותג שלכם להופיע בתשובות של ChatGPT ו-Perplexity',
      'Mekhayev — יצירת Brand Book שלם אוטומטית'
    ]},
    { id: 'p5', title: 'מנוע מחקר + זיכרון ארוך-טווח (RAG)', duration: '90 דק׳', points: [
      'מודיעין תחרותי אוטומטי — ללמד את הסוכן לסרוק מתחרים ולזכור הכל לאורך זמן',
      'Crawl4AI — סריקה עמוקה של אתרים, בלי להיחסם',
      'Firecrawl — לחלץ נתונים מובנים מכל אתר, גם כשהוא מסרב לשתף פעולה',
      'DataForSEO — מחקר מילות מפתח, SERP features ו-AEO ברמה מקצועית',
      'Mem0 + Qdrant — הזיכרון הארוך-טווח של הסוכן. איך הוא נבנה, איך שולטים בו',
      'Knowledge Base (RAG) — להעלות מסמכים שהסוכן יידע אותם לעד',
      'Reddit API ו-social listening מתקדם — לדעת מה אנשים באמת חושבים'
    ]},
    { id: 'p6', title: 'צוותי סוכנים עם CrewAI — כשסוכן אחד לא מספיק', duration: '75 דק׳', points: [
      'מתי סוכן אחד מגיע לגבול היכולת שלו — והרגע שצריך צוות שעובד יחד',
      'איך בונים Crew מותאם לעסק שלכם או לכל לקוח בנפרד',
      'דפוסי Orchestration — מי מדבר עם מי, מי מחליט, מי מבצע',
      'Deploy · Run · Monitor — להפעיל Crew אמיתי בסביבת ייצור',
      'סאב-סוכנים במקביל — לחסוך זמן על משימות מורכבות'
    ]},
    { id: 'p7', title: 'SEO + AEO — בגוגל, וגם בתשובות של ChatGPT', duration: '90 דק׳', points: [
      'שני עולמות מקבילים של חיפוש ב-2026 — למה אתם חייבים להיות בשניהם',
      'חיבור Google Search Console ושימוש אמיתי בנתונים — לא רק לראות גרפים',
      'SEO First-run Wizard — להביא אתר חדש ל-100% בקריטריונים של גוגל',
      'Schema Markup אוטומטי — הקוד ש"מסביר" לגוגל מי אתם',
      'AEO — איך להופיע בתוך תשובות של ChatGPT, Claude ו-Perplexity',
      'Entity Consensus — מה זה, ולמה בזכותו אתם עולים בדירוג',
      'Migdalor workflow — לבדוק בפועל שאתם מופיעים במודלים'
    ]},
    { id: 'p8', title: 'פרסום ממומן אוטומטי — Google ו-Meta דרך API', duration: '90 דק׳', points: [
      'לצאת מהממשק ולעבור לקוד — מה זה פותח, ומה זה מחייב',
      'Google Ads Developer Token — הגדרה מלאה, הרשאות, מה צריך להכין מראש',
      'חשבון MCC (על-חשבון) לסוכנויות — לנהל הרבה לקוחות ממקום אחד',
      'בניית קמפיינים דרך API — מאות קמפיינים בשעה, אם צריך',
      'Meta Ads — pipeline שלם לפייסבוק ואינסטגרם',
      'Creative Automation — 16+ קריאייטיבים לחודש, אוטומטית',
      'ROAS reporting ולולאות אופטימיזציה שהסוכן מריץ 24/7'
    ]},
    { id: 'p9', title: 'ניהול כל הערוצים בסקייל — Activepieces בפנים', duration: '60 דק׳', points: [
      'לנהל את כל ערוצי התקשורת בבת אחת — בלי לעקוב ידנית אחרי אף אחד',
      'WhatsApp Business — broadcasts ואישור תבניות במטא',
      'Google Business Profile — פוסטים אוטומטיים וטיפול בביקורות',
      'Activepieces לעומק — אוטומציות שחורגות ממה שסוכן יחיד עושה',
      'תזמון משימות (cron) — אסטרטגיה שלמה של מתי כל דבר קורה'
    ]},
    { id: 'p10', title: 'הצד הטכני — להרגיש בבית עם המערכת', duration: '60 דק׳', points: [
      'להפסיק לפחד לגעת — להבין מה קורה, איך לנפות בעיות, איך לתקן',
      'Terminal מובנה בדפדפן — מה אפשר לעשות משם, ומה עדיף להשאיר לי',
      'Console + Logs — לפרש התנהגות של הסוכן כשמשהו מוזר',
      'API Token — לחבר את הפלטפורמה למערכות חיצוניות של העסק',
      'גיבויים ושחזור — שלעולם לא תאבדו כלום, גם כשמשהו ישבר',
      'Health Monitoring וריפוי עצמי — איך המערכת מזהה בעיות ומתקנת אוטומטית',
      'LLM Guard — הגנה מפני Prompt Injection והתקפות על הסוכן'
    ]},
        ...
        <div className="wrap">
          ...
          <div className="plans-grid reveal">
            ...
            <div className="plan-card featured">
              ...
              <div className="plan-desc">
                הרחבה טבעית של מסלול בעלי העסקים. דרך עבודה אמיתית עם הפלטפורמה — צוללים לכל פינה:
                איך כל סוכן מקבל החלטות, איך עובד הזיכרון של OpenClaw, איך לבנות סוכנים מותאמים ועוצמתיים.
                למי שרוצה להבין עד הסוף, לבנות בעצמו, ואולי אפילו להקים סוכנות דיגיטלית משלו.
              </div>
              <div className="plan-price">₪1,499<small>חד-פעמי</small></div>
              <div className="plan-meta">~15 שעות · 12 מודולים · סרטון חדש כל שבוע · קבוצת טלגרם פעילה</div>

              <div className="plan-wants-label">תצאו עם היכולת ל...</div>
              <ul className="plan-features">
                <li><strong>לפתח סוכנים אופטימליים ועוצמתיים</strong> — להבין איך כל סאב-סוכן מקבל החלטות, לומד ומתקשר עם הסוכנים סביבו</li>
                <li><strong>לחסוך עד 90% מעלויות ה-AI</strong> — לבחור את המודל הנכון לכל משימה, בלי לאבד איכות</li>
                <li><strong>לשלוט בזיכרון של OpenClaw</strong> — לעצב איך הסוכן זוכר את העסק, את הלקוחות ואת המותג שלכם</li>
                <li><strong>לבנות יכולות חדשות בעצמכם</strong> — לכתוב Skills מותאמים, לחבר כלים, ליצור workflows ייחודיים</li>
                <li><strong>להפעיל Meta ו-Google Ads דרך API</strong> — אוטומציה מלאה של קמפיינים וקריאייטיבים</li>
                <li><strong>להוביל SEO + <Tip text="Answer Engine Optimization — להופיע בתשובות של ChatGPT, Claude, Perplexity כשאנשים שואלים שאלות בתחום שלכם.">AEO</Tip> מקצועי</strong> — להופיע גם בגוגל וגם בתשובות של ChatGPT ו-Perplexity</li>
                <li><strong>לעבוד לעומק עם Activepieces</strong> — אוטומציות שחורגות ממה שסוכן יחיד יכול לעשות</li>
                <li><strong>להקים סוכנות דיגיטלית על הפלטפורמה</strong> — Pricing, White-label, Onboarding ללקוחות</li>
              </ul>
      ...
      <section className="mod-section" style={{ background: 'var(--bg-3)' }}>
        <div className="wrap">
          <div className="mod-head reveal">
            ...
            <div className="mod-meta">12 מודולים · ~15 שעות · סרטון חדש כל שבוע · קבוצת טלגרם פעילה</div>
          </div>
          ...
          <div className="pros-intro reveal" style={{
            ...
            <div style={{ fontSize: '0.95rem', color: 'var(--ink)', fontWeight: 600, marginBottom: 14 }}>
              הקורס הזה חי, נושם ומתפתח איתכם
            </div>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 18 }}>
              <div>
                ...
                <div style={{ fontSize: '0.85rem', color: 'var(--ink-3)', lineHeight: 1.6 }}>
                  השוק דינמי, והקורס גם. קיבלתם גישה פעם אחת — מקבלים את כל העדכונים לכל החיים.
                </div>
              </div>
              <div>
                <div style={{ fontSize: '0.9rem', color: 'var(--ink-2)', fontWeight: 600, marginBottom: 4 }}>
                ...
                <div style={{ fontSize: '0.85rem', color: 'var(--ink-3)', lineHeight: 1.6 }}>
                  מדברים על טכנולוגיות חדשות, חולקים ניסויים, שואלים שאלות. אני שם באופן אישי.
                </div>
              </div>
              <div>
                <div style={{ fontSize: '0.9rem', color: 'var(--ink-2)', fontWeight: 600, marginBottom: 4 }}>
                ...
                <div style={{ fontSize: '0.85rem', color: 'var(--ink-3)', lineHeight: 1.6 }}>
                  המסלול כולל את מודולי הבסיס של בעלי העסקים — כדי שתפעילו את הפלטפורמה מהיום הראשון, ובמקביל תצללו לעומק בקצב שלכם.
                </div>
              </div>
              <div>
                <div style={{ fontSize: '0.9rem', color: 'var(--ink-2)', fontWeight: 600, marginBottom: 4 }}>
