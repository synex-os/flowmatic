...
export default function Home() {
  ...
  const courseSchema = [
    ...
    },
    {
      ...
      description: 'מסלול מומחיות למשווקים מקצועיים: לבנות מערכי שיווק AI עבור לקוחות ולהקים סוכנות דיגיטלית מבוססת הפלטפורמה',
      provider: { '@type': 'Organization', name: 'Flowmatic', url: 'https://flowmatic.co.il' },
  ...
  const ownersModules = [
    ...
    { id: 'o5', title: 'הסוכנים שעובדים בשבילכם — מי עושה מה', duration: '30 דק׳', points: [
      ...
      'הסוכן שמנהל לכם את הקמפיינים הממומנים (Mazhir) — Meta ו-Google Ads',
  ...
  const prosModules = [
    ...
    { id: 'p11', title: 'להפוך את הידע לעסק — סוכנות דיגיטלית משלכם', duration: '~75 דק׳', points: [
      ...
      'תוכנית השותפים של הפלטפורמה — הכנסה נוספת מהפניות',
  ...
  const faqs = [
    ...
    { q: 'האם הקורס כולל גישה לפלטפורמה?', a: 'לא — הקורס והפלטפורמה הם מוצרים נפרדים. הקורס מלמד אתכם לשלוט בפלטפורמה. תוכניות הפלטפורמה מתחילות מ-₪79 לחודש, עם 7 ימי ניסיון חינם.' },
    ...
    { q: 'אנחנו סוכנות דיגיטל. יש תנאים מיוחדים?', a: 'המסלול המקצועי כולל מודול שלם על הקמת סוכנות על הפלטפורמה: Pricing, White-label, Onboarding ללקוח. לסוכנויות גדולות עם צוות — דברו איתנו על רישוי צוותי.' }
  ]
